  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-4 mb-2 max-w-[260px] relative"
          >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="relative w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-xl shadow-green-500/30 cursor-pointer"
      >
        <motion.span
