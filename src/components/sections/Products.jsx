          ...
          {filtered.map((product, i) => (
            ...
            >
              <div className="relative h-52 sm:h-48 overflow-hidden bg-gray-100 dark:bg-gray-700">
                ...
                <div className="absolute top-3 left-3 px-3 py-1.5 bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm text-gray-900 dark:text-white text-[11px] font-semibold rounded-full shadow-sm">
                  {product.type}
                </div>
              ...
              <div className="p-4 sm:p-5">
                  ...
                  {(product.variants || []).length > 0 ? (
                    product.variants.map((v, vi) => (
                      <div key={vi} className="flex items-center justify-between">
                        <span className="text-[11px] text-gray-500 dark:text-gray-400">{v.name}</span>
                ...
                <div className="flex items-center gap-3 mt-3 pt-3 border-t border-gray-100 dark:border-gray-700/50 text-[11px] text-gray-500 dark:text-gray-400">
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <a
                    ...
                    className="px-3 sm:px-4 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-xl text-[11px] sm:text-xs font-semibold transition-all duration-300 flex items-center gap-1.5"
                  >
