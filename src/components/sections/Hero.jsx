    ...
    >
      ...
      >
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
          ...
          >
            <div className="rounded-full ring-4 ring-white/20 shadow-2xl mb-3 sm:mb-4">
              <img
            ...
            <p className="text-white/50 text-xs sm:text-sm mb-4">{profile.title || 'Sales Consultant'}</p>
            <motion.a
              href={getWhatsAppLink()}
              target="_blank"
              rel="noopener noreferrer"
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center gap-2 px-5 py-2.5 sm:py-3 bg-honda-red text-white rounded-xl font-semibold text-xs sm:text-sm hover:bg-red-600 transition-all shadow-lg shadow-honda-red/25 hover:shadow-xl hover:shadow-honda-red/30"
            >
