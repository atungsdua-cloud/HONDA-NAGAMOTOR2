...
export default function ProductDetail() {
  ...
  return (
    <PageTransition>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500" id="main-content">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-14">
            ...
            >
              {/* Title section */}
              <div>
                <h1 className="font-poppins font-bold text-3xl sm:text-4xl lg:text-5xl text-gray-900 dark:text-white leading-tight">
                  {product.name}
                </h1>
                {product.tagline && (
                  <p className="text-base sm:text-lg text-gray-500 dark:text-gray-400 mt-2">{product.tagline}</p>
                )}
              </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {colors.map((color, i) => (
                      <div key={i} className="flex flex-col items-center gap-1.5">
                        <div
                          className="w-10 h-10 rounded-full ring-2 ring-offset-2 ring-offset-white dark:ring-offset-gray-900 transition-transform hover:scale-110"
                          style={{ backgroundColor: color, ringColor: color === '#FFFFFF' ? '#D1D5DB' : color }}
                        />
                      </div>
                    ))}
            ...
            <div className="mt-12 lg:mt-20 pt-10 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <h2 className="font-poppins font-bold text-2xl text-gray-900 dark:text-white mt-1">
                    {product.type} Lainnya
                  </h2>
                </div>
                <Link to="/#produk" className="text-sm text-honda-red hover:underline font-medium">
                  Lihat Semua
                </Link>
              </div>
                ...
                {related.map((p) => (
                  ...
                  >
                    <div className="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-700">
                      ...
                      <div className="absolute top-3 left-3 px-2.5 py-1 bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm text-gray-900 dark:text-white text-[10px] font-semibold rounded-full">
                        {p.type}
                      </div>
                    </div>
                    <div className="p-4">
